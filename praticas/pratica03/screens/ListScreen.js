...
const styles = StyleSheet.create({
    container: {
        flex: 1, backgroundColor: "#FFFBFE", flexDirection: "column", justifyContent: "flex-start", alignItems: "stretch",
        appBar: {
            backgroundColor: "#6750A4", height: 64, paddingLeft: 16, paddingRight: 16, justifyContent: "center", marginBottom: 8, appTitle: {
                color: "#FFFFFF", fontSize: 22,
                fontWeight: "400", lineHeight: 28, alignSelf: "center", item: {
                    backgroundColor: "#FEF7FF", height: 72, borderBottomWidth: 1, borderBottomColor: "#79747E",
                    paddingTop: 8, paddingLeft: 16, paddingRight: 16, paddingBottom: 8, itemTitle: { color: "#1D1B20", fontSize: 16, fontWeight: "400", lineHeight: 24, },
